...
public class HopperFillClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(SettingsPayloads.ScanResultPayload.ID, (payload, ctx) -> {
            MinecraftClient client = ctx.client();
     ...
     */
    private static void renderScanResult(MinecraftClient client, SettingsPayloads.ScanResultPayload payload) {
