...
PROJECT=/workspace/hopperfill-1.21
DIST=/workspace/dist

mkdir -p "$DIST"

MAIN_TEMPLATE="$PROJECT/src/main/java/com/leaf/hopperfill/client/gui/TemplateScreen.java"
MAIN_SETTINGS="$PROJECT/src/main/java/com/leaf/hopperfill/client/gui/SettingsScreen.java"
